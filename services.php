...
<section class="bg-gray-900 text-white py-16">
  <div class="container mx-auto px-6 md:px-12">
    <h1 class="text-4xl md:text-5xl font-bold text-sky-400 mb-8 text-center">My Services</h1>
    <p class="text-gray-300 text-lg text-center mb-14">
      I offer practical, growth-focused digital services that are designed to help you build, launch, and grow. Whether you're a business owner, entrepreneur, or student with a dream, there's something here for you.
    </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      ...
      <div class="bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition">
        ...
        <h3 class="text-2xl font-semibold mb-2">Web App Development</h3>
        <p class="text-gray-300 mb-6">
      ...
      <div class="bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition">
        ...
        <h3 class="text-2xl font-semibold mb-2">Business Websites</h3>
        <p class="text-gray-300 mb-6">
      ...
      <div class="bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition">
        ...
        <h3 class="text-2xl font-semibold mb-2">E-commerce Setup</h3>
        <p class="text-gray-300 mb-6">
      ...
      <div class="bg-gray-800 rounded-xl p-6 shadow-lg transition">
        <div class="text-indigo-400 text-4xl mb-4">
          <i class="fas fa-graduation-cap"></i>
        </div>
        <h3 class="text-2xl font-semibold mb-2">Student Starter Pack</h3>
        <p class="text-gray-300 mb-6">
      ...
      <div class="bg-gray-800 rounded-xl p-6 shadow-lg transition">
        ...
        <h3 class="text-2xl font-semibold mb-2">Digital Strategy Session</h3>
        <p class="text-gray-300 mb-6">
